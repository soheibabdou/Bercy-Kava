...
<html><head><title>Bercy Kava Pay</title>
<style>
...
<h1>🔺 Bercy Kava Pay</h1>
<p>World's first <b>x402 + AC2</b> cross-border payment layer on Kava Mainnet.</p>
<div>
...
app.get("/api/health", async (req, res) => {
  try {
    ...
    res.json({ status: "ok", service: "Bercy Kava Pay", network: "Kava Mainnet", protocols: ["x402", "AC2"], totalCorridors: 95 });
  }
});
...
app.listen(PORT, () => console.log("Bercy Kava Pay running on port " + PORT));
